...
class LlvmGenerator:
    ...
    def printf(self, expression):
        ...
        if not len(expression):
            ...
            format_str_const = ir.Constant(ir.ArrayType(int8, len(format_str)), bytearray(format_str.encode('utf8')))
            ...
            self.builder.call(printf_func, [format_str_ptr, self.builder.load(variable["var"])])
